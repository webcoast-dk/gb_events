...
//$TCA['tt_content']['types']['list']['subtypes_addlist'][$_EXTKEY . '_main'] = 'pi_flexform';
//t3lib_extMgm::addPiFlexFormValue($_EXTKEY . '_main', 'FILE:EXT:' . $_EXTKEY . '/Configuration/FlexForms/flexform_main.xml');
